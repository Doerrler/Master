...
public class Player extends Mob {
	...
	public void render(Screen screen){
		...
		int modifier = 8 * scale; //this changes the scale of the character
		...
		screen.render(xOffset + (modifier * flipTop), yOffset, xTile + yTile * 32, color, flipTop, scale); // upper body part 1
