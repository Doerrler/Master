...
// Uses Scanner class a mix of Java and C IO.
...
// This version includes minor changes and command line parameter echoing
// Just for fun, try these to see how the command line arguments to main() 
// work:
//    java H3
...
public class H3 {
	...
	if (args == null || args.length == 0)  
          ...
          if (args.length == 1)  // next line uses C printf
            ...
            System.out.println("The arguments typed are as follow: ");
